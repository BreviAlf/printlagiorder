...
<script>
  ...
  function DoDelete() {
    ...
    window.open("<?php echo site_url() . 'backend/product/delete/'; ?>" + prod_id, "_self");
  }
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="d-flex mt-2 flex-row-reverse">
          <div class="p-2">
             <!-- <a href="#" class="btn btn-primary float-right" data-bs-target="#ModalUploadProduct" data-bs-toggle="modal">Upload CSV</a> -->
             <!-- <a href="#" class="btn btn-primary float-right" data-bs-target="#ModalExportProduct" data-bs-toggle="modal">Export MP</a> -->
             <!-- <a href="#" class="btn btn-primary float-right" data-bs-target="#ModalUpdateLink" data-bs-toggle="modal">Update Link MP</a> -->
            <a href="<?php echo site_url(); ?>backend/product/add" class="btn btn-primary float-right">Add Product</a>
        ...
        <table class="table datatable">
          ...
          <tbody>
            <?php foreach ($arr_product as $row_product) : ?>
              <tr>
                <th scope="row"><?php echo $row_product['prod_id']; ?></th>
                <td>
                  <img style="width:100px;" class="img-thumbnail" src="<?php echo site_url() . '' . $row_product['prod_img_mockup_url']; ?>" alt="">
                </td>
                <td>
                  <strong><?php echo $row_product['prod_name']; ?></strong><br>
                  <small><i><?php echo $row_product['prod_name_mp']; ?></i></small><br>
                  <small>SKU : <?php echo $row_product['prod_sku']; ?></small><br>
                  <small>SKU MP : <?php echo $row_product['prod_sku_mp']; ?></small><br>
                  <small>Link 1 : <div style="width: 700px;word-wrap: break-word;"><?php echo $row_product['prod_mp_link_1']; ?></div></small><br>
                 
                  <span class="badge rounded-pill bg-primary"><?php echo $row_product['cat_name']; ?></span>
                </td>
                <td>
                  <small>SKU : <?php echo $row_product['prod_sku']; ?></small><br>
                  <small>SKU MP : <?php echo $row_product['prod_sku_mp']; ?></small>
                </td>
                <td><?php echo count(GetVarianByProdId($row_product['prod_id']));?></td>
                <td><a href="<?php echo site_url() . 'backend/product/edit/' . $row_product['prod_id']; ?>" class="btn btn-primary btn-sm">Edit</a>
                  <a href="#" onclick="AlertDelete(<?php echo $row_product['prod_id']; ?>)" class="btn btn-danger btn-sm">Delete</a>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
