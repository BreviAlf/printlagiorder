        ...
        <form id="saveedit_var" action="<?php echo site_url() ?>backend/product/AjaxSaveEdit" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
          <div class="col-lg-6">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-9">
                <input type="text" type="text" name="prod_var_kel" id="prod_var_kel2" class="form-control" value="<?php echo $row_var->prod_var_kel;?>">
              </div>
            </div>
            <div class="row mb-3">
              <label for="inputText" class="col-sm-3 col-form-label">Multiply (Min)</label>
              <div class="col-sm-9">
                <input type="text" type="text" name="prod_var_multiply" id="prod_var_multiply2" class="form-control" value="<?php echo $row_var->prod_var_multiply;?>">
              </div>
            </div>
            <div class="row mb-3">
