  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <input type="text" id="spk_id" value=''>
      </div>
      <div class="modal-footer">
  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form method="post" action="http://192.168.1.72/printlagiorder/backend/spk/s2/0">
          <div class="row ">
            <div class="col-lg-9">
              <nav aria-label="Page navigation example">
                <ul class="pagination">
                  <a id="p_page" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=$pervious_page."/".$search_q?>"><li class="page-item" ><</li></a>
                  <a <?=$prev1?>  id="p_page2" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=($pervious_page-10)."/".$search_q?>"  ><li class="page-item" ><?= $current_offset/10-1 ?></li></a>
                  <a <?=$prev2?>  id="p_page1" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=$pervious_page."/".$search_q?>"  ><li class="page-item" ><?= $current_offset/10 ?></li></a>
                  <li class="page-item active"><a id="c_page" class="page-link"  ><?= $current_offset/10+1 ?></li></a>
                  <a <?=$next1?> id="n_page1" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=$next_page."/".$search_q?>"   ><li class="page-item" ><?= $current_offset/10+2 ?></li></a>
                  <a <?=$next2?> id="n_page2" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=($next_page+10)."/".$search_q?>"   ><li class="page-item" ><?= $current_offset/10+3 ?></li></a>
                  <a id="n_page" class="page-link" href="<?= base_url('backend/spk/') ?>s2/<?=$next_page."/".$search_q?>" ><li class="page-item" >></li></a>
                </ul>       
              </nav>
            </div>
            <div class="col-lg-3">
            ...
            <div class="col-sm-10">
              <select class="form-select" aria-label="Default select example">
                ...
                <?php// for( $i=0; $i<=$max_page; $i++) :?>
                  <option onclick=""><?php //echo $i?></option>
                  <?php// endfor?>
              </select>
            </div>
          </div> -->
          ...
          <tbody>
            ...
            <?php foreach ($arr_spk as $row_spk) : ?>
              <tr>
                ...
                <td><img style="width:100px;" class="img-thumbnail" src="<?php echo site_url() . '' . $row_spk['spk_image']; ?>" alt=""></td>
                <td><small><?php echo $row_spk['spk_no']; ?></small></td>
                <td><small><?php echo $row_spk['spk_inv_mp']; ?></td>
                ...
                <td>
                  <button type="button" onclick="GoProcess(<?php echo $row_spk['spk_id']; ?>)" class="btn btn-primary">Cetak</button>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
