...
function GoSpkInput() {
  ...
  function embedJS(id) {
    // var arrNoSPK = "123456789";
    // var arrNoSPK2 = document.getElementById("arrNoSPK2").innerHTML
    // alert(arrNoSPK2);
    var text = "List of Things"

    $.ajax({
      url: '<?php echo site_url() . 'backend/BatchSpk/embedPHP' ?>',
      cache: false,
      dataType: "json",
      type: 'POST',
      data: {text: text},
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <?php if($input!='disabled'):?>
                      ...
                      <!-- <a href="javascript:void(0)" class="btn btn-primary float-right" onclick="embedJS(1);InputDeadline(<?php echo $batch_spk_id;?>)">Kirim dan Cetak Batch</a> -->
                      <a href="javascript:void(0)" class="btn btn-primary float-right" onclick="embedJS();">Kirim dan Cetak Batch</a>
      ...
      <div class="card-body">
        <h2 class="card-title">Batch : <?php echo $data_batch->batch_spk_name;?></h2>
          <div class="row">
            ...
            <div class="row mb-3">
                <label for="batch_spk_det_spk_no" class="col-sm-2 col-form-label"><h4>SPK NO TESTING</h4></label>
                <div class="col-sm-9">
            ...
            <div class="col-lg-8">
              <div id="load_data_spk">
                ...
                <div class="table-responsive">
                  ...
                  <tbody>
                    <?php $arrNoSPK="";foreach ($arr_spk_det as $row_spk_det) : ?>
                    ...
                    <?php $arrNoSPK = $row_spk_det['batch_spk_det_spk_no'].";".$arrNoSPK;endforeach; ?>
                  </tbody>
                </table>
                        </div>         
              </div>
              ...
              <input id="batch_spk_id" type="hidden" name="batch_spk_id" id="batch_spk_id" class="form-control" value="<?php echo $batch_spk_id;?>">
                ...
                <a href="http://192.168.2.176/printlagiorder/backend/batchspk/embedPHP" target="_blank">Embed</a>
                        <?php echo $arrNoSPK . "<br>"; print_r (explode(";",strrev(substr(strrev($arrNoSPK), 1))));  ?>
                        <p id="arrNoSPK"><?=$arrNoSPK?></p>
                        <p id="arrNoSPK2">321</p>

                        <form action="http://192.168.2.176/printlagiorder/backend/batchspk/embedPHP" method="POST">
