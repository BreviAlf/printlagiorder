				...
				<form action="" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="name_marketing" class="form-control" value="<?php echo set_value('name_marketing');?>">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon" for="phone_1">Phone 1</span>
							<input type="text" name="phone_1" class="form-control" value="">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon" for="phone_2">Phone 2</span>
							<input type="text" name="phone_2" class="form-control" value="">
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon" for="phone_1">Email </span>
