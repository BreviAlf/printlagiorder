...
class BatchSpk extends CI_Controller {
	...
	//target3
 public function embedPHP(){
	$text = print_r($this->input->post('text'));
	echo "post 'text' <br> >";print_r($text); exit;
	include_once APPPATH . '/third_party/fpdf/fpdf.php';
  include_once APPPATH . '/third_party/fpdi/src/autoload.php';
    {
      // initiate FPDI
      // $pdf = new \setasign\Fpdi\Fpdi('L','mm',);
      $pdf = new \setasign\Fpdi\Fpdi('L','mm',);
      
      $pdf->setSourceFile('D:\Order\2024\Oct\23\FINAL\Layer1.pdf');
      ...
      $pdf = new \setasign\Fpdi\Fpdi($orientation,'mm',array($width,$height));
      ...
      $pdf->setSourceFile('D:\Order\2024\Oct\23\FINAL\Layer2.pdf');
      $tplIdx = $pdf->importPage(1);
      $pdf->useTemplate($tplIdx, 0, 0, );
      ...
      // $pdf->Image('public/media/up.jpg', 21, 17, 8, 8, 'jpg');

      // $pdf->Output('I', 'generated.pdf');
      // $day = date('d');
      // $month = date('M');
      // $year = date('Y');
      // $dest = 'D:\\Order'.'\\'.$year.'\\'.$month.'\\'.$day.'\\FINAL\\';
      // $pdf->Output('F', $dest.'generated1.pdf');
      $pdf->Output('F', 'D:\Order\2024\Oct\23\FINAL\Result6.pdf');
      // $pdf->Output($dest, 'generated.pdf');
