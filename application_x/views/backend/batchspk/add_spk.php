...
<div class="modal fade" id="ModalConfirmBatch" role="dialog">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="datetime-local" name="batch_spk_date_deadline" id="batch_spk_date_deadline" class="form-control" required>
                </div>
              </div>
      </div>
