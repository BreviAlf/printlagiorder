...
<script>
  ...
  function DoProcess() {
    var spk_id = $("#spk_id").val();
    window.open("<?php echo site_url() . 'backend/spk/do_process/'; ?>" + spk_id+'', "_self");
  }
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="DoProcess()" class="btn btn-primary">Process </button>
      </div>
    </div>
  </div>
</div>
          ...
          <tbody>
            <?php foreach ($arr_spk as $row_spk) : ?>
              <tr>
                ...
                <td>
                  <button type="button" onclick="GoProcess(<?php echo $row_spk['spk_id']; ?>)" class="btn btn-primary">Process</button>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
