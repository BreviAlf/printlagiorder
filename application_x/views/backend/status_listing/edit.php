...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="panel panel-default">
			...
			<form id="form_listing" action="<?php echo site_url(). 'backend/m_listing/edit/'.$row->id_listing;?>" role="form" method="post" enctype="multipart/form-data">
					<div class="col-lg-6">
					...
					<div class="col-lg-6">
						...
						<div class="form-group input-group">
							...
							<input type="text" name="spesifikasi" class="form-control" value="<?php echo $row->spesifikasi; ?>">
						</div>
						<div class="form-group input-group">
