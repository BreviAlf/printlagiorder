  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <form action="<?php echo site_url() ?>backend/material/add" method="post" class="row g-3 needs-validation" enctype="multipart/form-data" novalidate>
          <div class="row">
            <div class="col-lg-7">
              <div class="row mb-3">
                <label for="material_name" class="col-sm-3 col-form-label">Material_name</label>
                <div class="col-sm-9">
                  <div class="input-group has-validation">
                    ...
                    <div class="invalid-feedback">Please enter Material name.</div>
                  </div>
                </div>
              </div>
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <textarea name="material_code" class="form-control" style="height: 100px"></textarea>
                </div>
              </div>
              <div class="row mb-3">
                <label for="material_gsm" class="col-sm-3 col-form-label">material_gsm</label>
                <div class="col-sm-9">
                  <textarea name="material_gsm" class="form-control" style="height: 100px"></textarea>
                </div>
              </div>
              <div class="row mb-3">
                <label for="material_price" class="col-sm-3 col-form-label">material_price</label>
                <div class="col-sm-9">
                  <textarea name="material_price" class="form-control" style="height: 100px"></textarea>
                </div>
              </div>
