<script>
  ...
  cbChanged = function(checkboxElem) {
    var b_name_ori = '<?php echo GenBatchName();?>';
    var b_name =  $("#batch_spk_name").val();
      if (checkboxElem.checked) {
          $("#batch_spk_name").val('URGENT-'+b_name);
      } else {
          //alert('unc');
          $("#batch_spk_name").val(b_name_ori);
      }
    }
</script>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  ...
                  <div class="mt-1 form-check">
                      <input class="form-check-input" onClick="cbChanged(this);" type="checkbox" id="urgent_check">
