...
<script>
  ...
  function DoDone() {
    var spk_id = $("#spk_id").val();
    window.open("<?php echo site_url() . 'backend/spk/do_done/'; ?>" + spk_id+'', "_self");
  }
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" onclick="DoDone()" class="btn btn-primary">Selesaikan</button>
      </div>
    </div>
  </div>
</div>
          ...
          <tbody>
            <?php foreach ($arr_spk as $row_spk) : ?>
              <tr>
                ...
                <td>
                  <button type="button" onclick="GoProcess(<?php echo $row_spk['spk_id']; ?>)" class="btn btn-primary">Selesaikan</button>
                </td>
              </tr>
            <?php endforeach; ?>
          </tbody>
